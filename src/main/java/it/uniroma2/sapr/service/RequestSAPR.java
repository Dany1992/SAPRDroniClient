 ...
 *         &lt;element name="checkSapr" type="{http://service.sapr.uniroma2.it/}checkElement" maxOccurs="unbounded" minOccurs="0"/>
    ...
    extends Request
{
    ...
    protected List<CheckElement> checkSapr;
     ...
     * 
     */
    public List<CheckElement> getCheckSapr() {
        if (checkSapr == null) {
            checkSapr = new ArrayList<CheckElement>();
        }
