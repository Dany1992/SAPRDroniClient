...
<body>
	...
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">
				Admin page <small>Operation</small>
			</h1>
		</div>
	</div>
	...
	<div class="row col-lg-6">
		<div class="portfolio-item">
			...
			<p>In this section you can fill the fields, then enter a new
				pilot</p>
		</div>
	</div>
	...
	<div class="row col-lg-6">
		<div class="portfolio-item">
			...
			<p>In this section you may delete pilot simply inserting pilot's
				licence that you want to delete.</p>
		</div>
	</div>
